...
export default function Index() {
  ...
  function handleAddEmail() {
    ...
    const emailAreadyExsists = emailsToInvite.find(
      (email) => email === emailToInvite
    );

    if (emailAreadyExsists) {
      return Alert.alert("Convidado", "Convidado já foi adicionado");
    }
  ...
  return (
    <View className="flex-1 justify-center items-center px-5">
      ...
      <Modal
        ...
        visible={showModal === MODAL.GEST}
        onClose={() => setShowModal(MODAL.NONE)}
      >
        <View className="my-2 flex-wrap gap-2 border-b border-l-zinc-800 py-5 items-start">
